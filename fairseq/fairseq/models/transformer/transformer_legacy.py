...
# parameters used in "Causes and Cures for Interference in Multilingual Translation" paper (Shaham et al., 2023)
@register_model_architecture("transformer", "transformer_xl_704m")
def transformer_xl_704m(args):
