...
@register_task("translation_multi_calc_el2n")
class TranslationMultiCalcEl2n(LegacyFairseqTask):
    """
    ...
    def add_args(parser):
        ...
        parser.add_argument('--filename', default='/scratch4/danielk/tli104/el2n.txt', 
                            help='the path you want to print your el2n')
    ...
    def train_step(
        ...
        with torch.autograd.profiler.record_function("forward"):
            with torch.cuda.amp.autocast(enabled=(isinstance(optimizer, AMPOptimizer))):
                loss, sample_size, logging_output = criterion(model, sample, print_scores=self.args.filename)
        loss *= 0
